...
#pragma warning (pop)
	...
	void GraphicsPipeline::CreateImage(uint32_t width, uint32_t height, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, uint32_t mipLevels, VkSampleCountFlagBits numSamples, VkImage& image, VkDeviceMemory& imageMemory)
	{
	...
	void GraphicsPipeline::TransitionImageLayout(VkImage image, VkFormat format, uint32_t mipLevels, VkImageLayout newLayout, VkImageLayout oldLayout)
	{
		VkCommandBuffer commandBuffer = BeginSingleTimeCommands();
	...
	void GraphicsPipeline::GenerateMipmaps(VkImage image, VkFormat imageFormat, int32_t texWidth, int32_t texHeight, uint32_t mipLevels)
	{
